...
public class UserManagerControllerIT {
    ...
    public void testPostManagerUsernameUnique() {
        ...
        assertNotEquals(userRestService.getManagerDto2().getUsername(),
    ...
    public void testPatchManagerSetRole() {
        ...
        assertArrayEquals(uDto.getRoles(), newRoles);
        ...
        assertArrayEquals(uDto.getRoles(), restartRoles);
    ...
    public void testGetFullManagers() {
        assertTrue(userRestService.getFullManagers().size() > 0);
    }
